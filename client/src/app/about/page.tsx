            ...
            {timelineEvents.map((event, index) => (
              ...
              >
                <div className="flex flex-col items-center mr-6">
                  <div className="w-12 h-12 bg-blue-600 text-white rounded-full flex items-center justify-center text-sm font-bold shadow-lg p-1">{event.year}</div>
      ...
      <section className="py-10 md:py-12 bg-gray-100">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={containerVariants}>
            ...
            <motion.h2 variants={itemVariants} className="text-3xl md:text-4xl font-bold mb-12">የዚህ ፋውንዴሽን መስራቾች</motion.h2>
 ...
 {/* --- NEW: TEAM MESSAGE SECTION --- */}
      <section className="py-10 md:py-12 bg-blue-50">
        <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            >
                <motion.div variants={itemVariants} className="inline-block text-blue-600 text-5xl mb-4">
                    <FaHandsHelping />
                </motion.div>
