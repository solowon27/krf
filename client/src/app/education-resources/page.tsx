...
const onlineLearningPlatforms = [
  {
    ...
    description: "ነፃ እና ዓለም አቀፍ ደረጃ ትምህርት በቪዲዮ እንዲሁም በተለያዩ ፕላትፎርሞች ሂሳብ፣ ሳይንስ፣ ታሪክ፣ ኢኮኖሚክስ እና ሌሎችንም ይማሩ።",
    icon: "🎓"
  },
  {
    name: "National Geographic Education",
    url: "https://education.nationalgeographic.org/",
    description: "ከሳይንስ፣ ጂኦግራፊ እና ማህበራዊ ጥናቶች ጋር የተያያዙ ትምህርቶችን፣ የትምህርት ዕቅዶችን እና ሌሎችንም እዚህ ያግኙ።",
    icon: "🌍"
  },
  {
    name: "Coursera (Free Courses)",
    url: "https://www.coursera.org/courses?query=free",
    description: "ከከፍተኛ ዩኒቨርሲቲዎች እና ኩባንያዎች ሰፊ የነፃ ኮርሶችን ያግኙ.",
    icon: "💡"
  },
  {
    name: "edX (Free Courses)",
    url: "https://www.edx.org/free-online-courses",
    description: "በዓለም ዙሪያ ካሉ እንደ ሃርቫርድ አይነት መሪ የአካዳሚክ ተቋማት ነፃ ኮርሶችን ያግኙ ።",
    icon: "🏫"
  },
  {
    name: "Duolingo",
    url: "https://www.duolingo.com/",
    description: "አዲስ ቋንቋ ይማሩ። የቋንቋ ችሎታዎን ለማዳበር እና ለማሻሻል ይሄን ይጫኑ።",
    icon: "🗣️"
  },
  {
