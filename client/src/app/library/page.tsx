        ...
        <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-1 lg:grid-cols-4 lg:gap-12">
            ...
            <main className="lg:col-span-3" ref={booksContainerRef}>
                  ...
                  >
                    {displayedBooks.map((book) => (
                      <motion.div
                        ...
                        className="bg-gray-900/50 border border-gray-800 rounded-lg overflow-hidden transition-all duration-300 hover:border-cyan-500 hover:shadow-2xl hover:shadow-cyan-500/10 hover:-translate-y-1 flex flex-col"
                      >
              ...
              <div className="lg:hidden mt-16 pt-12 border-t border-gray-700">
                {archiveContent}
              </div>
            </main>
          </div>
