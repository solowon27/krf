  ...
  return (
    <main className="w-full min-h-screen bg-gray-50 text-gray-800 font-sans antialiased overflow-x-hidden">
      ...
      <section className="bg-gradient-to-br from-teal-800 to-teal-600 text-white py-40 px-6 text-center relative overflow-hidden pt-24">
        ...
        ></div>
        <motion.div className="w-full px-4 mt-10 relative z-10"
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-teal-50 via-white to-amber-50 relative overflow-hidden">
        ...
        {/* Removed initial and whileInView from this motion.div */}
        <div
        ...
        >
          <motion.h2 variants={itemVariants} initial="hidden" animate="visible" className="text-5xl md:text-6xl font-extrabold mb-4 text-center text-teal-900 drop-shadow-md">
            Our Heartfelt Gratitude
          </motion.h2>
          <motion.p variants={itemVariants} initial="hidden" animate="visible" className="text-xl md:text-2xl text-center text-amber-700 font-semibold mb-4">
          ...
          {loading ? (
            ...
            <motion.div
              variants={containerVariants} // Keep container variants for stagger effect on children
              initial="hidden"
              animate="visible"
              className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" // Responsive grid with 3 columns on large screens
            >
